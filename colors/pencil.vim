...
call s:h("DiffAdd",       {"bg": s:bg_very_subtle, "fg": s:green})
call s:h("DiffDelete",    {"bg": s:bg_very_subtle, "fg": s:red})
call s:h("DiffChange",    {"bg": s:bg_very_subtle, "fg": s:dark_yellow})
call s:h("DiffText",      {"bg": s:bg_very_subtle, "fg": s:dark_blue})
